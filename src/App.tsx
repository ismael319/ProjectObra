...
const CampoLancamento = lazy(() => import('@/pages/apontamento/campo/CampoLancamento'))
              ...
              <BrowserRouter>
                <Suspense fallback={<LoadingFallback />}>
                  <Routes>
                    ...
                    {/* Login automático com conta compartilhada — sem ProtectedRoute,
                        pois não há tela de login pra quem acessa por este link. */}
                    <Route path="/campo/lancamento" element={<CampoLancamento />} />

  ...
  const scheduleInfo = useMemo(() => {
    ...
    return selectedCronogramasData.map((c) => {
      ...
      for (const act of c.dados?.activities || []) {
        ...
        if (blf) {
          const blfDate = toDate(blf)
          if (!blFinish || blfDate > blFinish) blFinish = blfDate
        }
      }
      ...
      return {
        ...
        nome: c.nome,
        cor: c.cor,
        start: c.dados?.startDate ? toDate(c.dados.startDate) : null,
        finish: c.dados?.finishDate ? toDate(c.dados.finishDate) : null,
        blFinish,

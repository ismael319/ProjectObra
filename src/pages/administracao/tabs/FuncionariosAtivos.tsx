...
import { Search, Plus, Upload, Pencil, Power, ChevronLeft, ChevronRight } from "lucide-react";
...
import { useFuncionarios, useRhCargos, useRhSetores, useRhGrupos } from "@/lib/administracao/catalog";
          ...
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                ...
                {!isLoading && pagina.length === 0 && <TableRow><TableCell colSpan={8} className="text-center py-8 text-muted-foreground">Nenhum funcionário encontrado</TableCell></TableRow>}
                {pagina.map((f) => (
                  <TableRow key={f.id}>
                    ...
                    <TableCell>
                      <div className="flex gap-1">
                        ...
                        <Button size="icon" variant="ghost" className="h-8 w-8 text-destructive" onClick={() => setDesligando(f)} title="Desligar">

      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">1. Dados Coletados e Base Legal</h2>
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900">Dados de Cadastro do Usuário</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900">Dados de Navegação e Auditoria</h3>
                <p className="text-sm text-gray-600 mt-1">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900">Dados de Terceiros Inseridos na Plataforma</h3>
                <p className="text-sm text-gray-600 mt-1">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">2. Finalidade do Tratamento de Dados</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">3. Papel na LGPD (Controlador vs. Operador)</h2>
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900">Como Controladora</h3>
                <p className="text-sm text-gray-600 mt-1">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                <h3 className="font-semibold text-gray-900">Como Operadora</h3>
                <p className="text-sm text-gray-600 mt-1">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">4. Compartilhamento e Transferência Internacional de Dados</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">5. Segurança da Informação</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">6. Retenção e Exclusão de Dados</h2>
            <div className="overflow-x-auto">
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="bg-gray-100">
                    <th className="text-left p-3 font-semibold text-gray-900 border">Categoria</th>
                    <th className="text-left p-3 font-semibold text-gray-900 border">Prazo</th>
                    <th className="text-left p-3 font-semibold text-gray-900 border">Justificativa</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-3 border text-gray-600">Dados cadastrais e operacionais</td>
                    <td className="p-3 border text-gray-600">Enquanto a conta estiver ativa</td>
                    <td className="p-3 border text-gray-600">Execução do contrato</td>
                  </tr>
                  <tr>
                    <td className="p-3 border text-gray-600">Dados após encerramento da conta</td>
                    <td className="p-3 border text-gray-600">Exclusão em até 30 dias</td>
                    <td className="p-3 border text-gray-600">Período de tolerância para exportação</td>
                  </tr>
                  <tr>
                    <td className="p-3 border text-gray-600">Logs de auditoria e acesso</td>
                    <td className="p-3 border text-gray-600">180 dias</td>
                    <td className="p-3 border text-gray-600">Marco Civil da Internet (art. 15)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border text-gray-600">Backups automáticos</td>
                    <td className="p-3 border text-gray-600">Até 30 dias (máx. 3 versões)</td>
                    <td className="p-3 border text-gray-600">Continuidade operacional</td>
                  </tr>
                  <tr>
                    <td className="p-3 border text-gray-600">Notificações internas</td>
                    <td className="p-3 border text-gray-600">90 dias</td>
                    <td className="p-3 border text-gray-600">Limpeza operacional</td>
                  </tr>
                  <tr>
                    <td className="p-3 border text-gray-600">Links temporários de exportação</td>
                    <td className="p-3 border text-gray-600">7 dias</td>
                    <td className="p-3 border text-gray-600">Segurança da informação</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">7. Direitos dos Titulares</h2>
            <p className="text-gray-600 mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">8. Contato e Encarregado de Dados (DPO)</h2>
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-gray-600">
              ...
              <div className="mt-3 space-y-2">
                <p className="text-sm">
                  <strong className="text-gray-900">DPO / Encarregado:</strong>{' '}
                  <a href="mailto:dpo@fgidecision.com.br" className="text-blue-600 hover:underline">dpo@fgidecision.com.br</a>
                  <br />
                  <span className="text-gray-500">— direitos do titular (LGPD), requisições legais e contratos</span>
                </p>
                <p className="text-sm">
                  <strong className="text-gray-900">Suporte Técnico:</strong>{' '}
                  <a href="mailto:suporte@fgidecision.com.br" className="text-blue-600 hover:underline">suporte@fgidecision.com.br</a>
                  <br />
                  <span className="text-gray-500">— dúvidas de uso, incidentes técnicos e auxílio na exportação de dados</span>
                </p>
              </div>
            </div>

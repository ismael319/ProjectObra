      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Acordo de Tratamento de Dados (DPA)</h1>
          ...
          <div className="prose prose-gray max-w-none">
            <p className="text-gray-600">
              Este instrumento regula a relação entre a <strong>FGI Decision</strong> (na qualidade de Operadora) e o
            ...
            <p className="text-gray-600">
              A FGI Decision tratará dados pessoais exclusivamente em nome do Cliente e de acordo com suas instruções
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">2. Categorias de Dados e Titulares</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">3. Obrigações da FGI Decision (Operadora)</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">4. Sub-processadores</h2>
            <p className="text-gray-600">
              O Cliente autoriza a FGI Decision a engajar sub-processadores terceiros (provedores de infraestrutura de
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">5. Transferência Internacional de Dados</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">6. Devolução e Eliminação de Dados</h2>
            <p className="text-gray-600">
              ...
              este prazo, a FGI Decision eliminará permanentemente todos os dados e cópias dos seus servidores de
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">7. Responsabilidade e Indenização</h2>
            <p className="text-gray-600">
            ...
            <p className="text-gray-600 mt-2">
              A FGI Decision responde civilmente apenas pelos danos causados em virtude do exercício da atividade de
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">8. Auditoria</h2>
            <p className="text-gray-600">
              Mediante solicitação formal por escrito com antecedência mínima de 30 (trinta) dias, limitada a 1 (uma)
              requisição por ano contratual, a FGI Decision disponibilizará ao Cliente evidências documentais,
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">9. Contato do Encarregado (DPO)</h2>
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-gray-600">
                Para comunicações formais, notificações sobre privacidade ou requisições relacionadas a este Acordo,
                o canal oficial de contato com o Encarregado de Proteção de Dados (DPO) da FGI Decision é:{' '}

      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">1. Objeto</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">2. Cadastro e Responsabilidades do Usuário</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">3. Disponibilidade e Manutenção</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">4. Propriedade Intelectual e Uso de Dados</h2>
            <ul className="list-disc pl-6 space-y-1 text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">5. Limitação de Responsabilidade</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">6. Proteção de Dados (LGPD)</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">7. Planos, Pagamento e Inadimplência</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">8. Cancelamento e Exclusão Definitiva de Dados</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">9. Backups e Exportação de Arquivos</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">10. Aplicativo Instalável (PWA) e Modo Offline</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">11. Alterações Nestes Termos</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">12. Foro</h2>
            <p className="text-gray-600">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">13. Canais Oficiais de Contato</h2>
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-sm">
                <strong className="text-gray-900">Comercial e jurídico:</strong>{' '}
                <a href="mailto:contato@fgidecision.com.br" className="text-blue-600 hover:underline">contato@fgidecision.com.br</a>
                <br />
                <span className="text-gray-500">— propostas comerciais, contratos e notificações legais</span>
              </p>
              <p className="text-sm mt-2">
                ...
                <br />
                <span className="text-gray-500">— dúvidas de uso, incidentes técnicos e falhas operacionais</span>
              </p>
              <p className="text-sm mt-2">
                ...
                <br />
                <span className="text-gray-500">— direitos dos titulares (LGPD) e requisições de privacidade</span>
              </p>
            </div>

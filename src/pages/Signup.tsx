      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">Comece a gerenciar seus projetos</p>
          </div>
          ...
          <div className="flex bg-gray-100 dark:bg-gray-900 rounded-lg p-1 mb-6">
            <Link
              to="/login"
              className="flex-1 py-2 text-sm font-medium rounded-md text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 text-center"
            >
              Entrar
            </Link>
            <Link
              to="/signup"
              className="flex-1 py-2 text-sm font-medium rounded-md bg-white dark:bg-gray-800 shadow text-gray-900 dark:text-white text-center"
            >
              Criar conta
            </Link>
          </div>
